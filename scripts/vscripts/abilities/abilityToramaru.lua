...
function OnToramaru02SpellStartDown(keys)
	...
	if caster:GetModifierStackCount("thtd_toramaru_02", caster) == nil then
		caster:SetModifierStackCount("modifier_toramaru_02_money_stack", caster, 1)
	end

	local interest = caster:GetModifierStackCount("modifier_toramaru_02_money_stack", caster) * 5000 * 0.02 * caster:THTD_GetStar () or 1
